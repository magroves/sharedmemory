/*
* B.c is a process file that runs simultaneously to A.c and C.c
...
main()
{
    ...
    // wait until process A writes "1" into shared memory
    while( *shm_i != 1 )
        sleep(1);
    
    // continue. program will stay in loop until 1 is read from shm_i
    
    //write "shared" into string shm
